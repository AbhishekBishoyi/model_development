...
#' The first function will extract unique text fields in a variable. This returns a vector of 
#' unique text fields.
#' The second function will create columns for unique text and return a data frame. 
#' 
